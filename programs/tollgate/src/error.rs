...
pub enum TollgateError {
    #[msg("The provided pool is not a valid DAMM pool")]
    InvalidPool,
    #[msg("The provided pool config is not a valid DAMM pool config")]
    InvalidPoolConfig,
    #[msg("The provided position is not a valid DAMM position")]
    InvalidPosition,
    #[msg("The provided pool does not match the provided pool config")]
    PoolConfigMismatch,
    // #[msg("The provided vault does not match the pool's vault")]
    // VaultMismatch,
    ...
    #[msg("The provided AMM program does not match the expected DAMM program")]
    AMMProgramMismatch,
